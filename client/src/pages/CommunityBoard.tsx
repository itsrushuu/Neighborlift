    ...
    <div className="noticeboard-surface min-h-screen bg-[#fbfaf6] text-stone-900">
      ...
      <main className="container px-5 pb-16 pt-9 sm:px-7 sm:pt-14">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_19rem] lg:items-end">
          ...
          <div className="board-tip"><p className="relative z-10 text-sm font-bold text-[#425135]">Demo board</p><p className="relative z-10 mt-1 text-sm leading-5 text-[#607050]">Sample posts make the matching experience easy to explore for HackSocial judges.</p></div>
        </div>
