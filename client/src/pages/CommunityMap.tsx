...
const friendlyPrompts = [
  "A small offer can make someone’s whole day easier.",
  "Have a little time to spare? Someone nearby may need it.",
  "Every neighbor has something useful to share.",
  "A kind hello can become a really practical hand.",
];
...
export default function CommunityMap() {
  ...
  useEffect(() => {
    ...
    const interval = window.setInterval(() => setPromptIndex(current => (current + 1) % friendlyPrompts.length), 6500);
