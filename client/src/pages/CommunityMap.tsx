...
export default function CommunityMap() {
  ...
  return <div className="min-h-screen bg-[#fbfaf6] text-stone-900"><SiteHeader /><main className="container px-5 py-9 sm:px-7 sm:py-14"><div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end"><div><p className="section-kicker">Live community map</p><h1 className="mt-3 max-w-3xl font-display text-4xl font-extrabold leading-[0.98] tracking-[-0.055em] text-stone-950 sm:text-5xl">See where neighbors are showing up.</h1><p className="mt-5 max-w-2xl text-base leading-7 text-stone-600">Find a little help close to home. We show approximate areas so neighbors can connect without sharing an exact address.</p></div><div className="map-live-note"><span className="live-dot" />{isFetching ? "Checking for new neighbor posts…" : hasLivePosts ? "Live community activity" : "A few examples for now · live when neighbors post"}</div></div>
